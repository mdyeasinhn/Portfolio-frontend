...
// Feature Item Component - Pure UI
...
// Project Stats Component - Pure UI
const ProjectStats = () => {
  return (
    <div className="grid grid-cols-2 gap-3 md:gap-4 p-3 md:p-4 bg-[#0a0a1a] rounded-xl overflow-hidden relative">
      ...
      <div className="relative z-10 flex items-center space-x-2 md:space-x-3 bg-white/5 p-2 md:p-3 rounded-lg border border-blue-500/20 transition-all duration-300 hover:scale-105 hover:border-blue-500/50 hover:shadow-lg">
        ...
        <div className="flex-grow">
          <div className="text-lg md:text-xl font-semibold text-blue-200">5</div>
...
// Main ProjectDetails Component - UI Only
const ProjectDetailsDesign = () => {
  // Sample project data for display purposes
  const sampleProject = {
    title: "Project Title",
    content: "This is a sample project description. It showcases the project's purpose, goals, and overall value proposition. The text is meant to give visitors a clear understanding of what this project is about.",
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-8 md:py-16">
          ...
          <div className="flex items-center space-x-2 md:space-x-4 mb-8 md:mb-12 animate-fadeIn">
            ...
            <div className="flex items-center space-x-1 md:space-x-2 text-sm md:text-base text-white/50">
              ...
              <span className="text-white/90 truncate">{sampleProject.title}</span>
            </div>
          </div>
            ...
            <div className="space-y-6 md:space-y-10 animate-slideInLeft">
              ...
              <div className="space-y-4 md:space-y-6">
                ...
                <div className="flex flex-wrap gap-2 md:gap-3">
                  {sampleProject.techStack.map((tech, index) => (
...
export default ProjectDetailsDesign;